...
export default registerAs(
  'auth',
  (): AuthConfig => ({
    jwtAccessSecret: process.env.JWT_ACCESS_SECRET || 'dev_jwt_access_secret_do_not_use_in_production_123456789',
    jwtAccessExpiresIn: process.env.JWT_ACCESS_EXPIRES_IN || '15m',
    jwtRefreshSecret: process.env.JWT_REFRESH_SECRET || 'dev_jwt_refresh_secret_do_not_use_in_production_987654321',
    ...
    passwordResetExpirationMinutes: parseInt(process.env.PASSWORD_RESET_EXPIRATION_MINUTES || '30', 10),
  }),
);
