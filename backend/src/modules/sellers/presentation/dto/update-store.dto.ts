...
export class UpdateStoreDto {
  ...
  @ApiPropertyOptional({
    example: 'Handcrafted fashion, makeup and cosmetics',
  ...
  @ApiPropertyOptional({
    example: 'https://cdn.example.com/new-banner.png',
  ...
  @ApiPropertyOptional({
    example: 'contact@lotusboutique.com',
  ...
  @ApiPropertyOptional({
    example: 'Standard and Same-Day delivery options',
